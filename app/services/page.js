...
export default function Service_Four() {

    useEffect(() => {
    document.title = "Services | Neen Inovations | One-stop solution for market & academic research";
  }, []);
    ...
    return (
        <div className="boxed_wrapper">
            ...
            <section className="service-style service-style-three service-page-section service-four-page-section alternat-2">
                ...
                <div className="outer-container">
                    <div className="title-box mb_90 centred">
            ...
            <section className="chooseus-section alternat-2 sec-title-animation animation-style2">
                <div className="shape-2 float-bob-y" style={{ backgroundImage: "url(/assets/images/shape/shape-165.png)" }}></div>
                <div className="outer-container">
                    <div className="row clearfix">
                    ...
                    <div className="testimonial-content p_relative z_1 pt_160">
                        <div className="row clearfix">
                            <div className="col-lg-6 col-md-12 col-sm-12 testimonial-block">
            ...
            <section className="discuss-section alternat-2 centred">
                <div className="pattern-layer" style={{ backgroundImage: "url(/assets/images/shape/shape-3.jpg)" }}></div>
                <div className="dark-pattern" style={{ backgroundImage: "url(/assets/images/shape/shape-86.png)" }}></div>
