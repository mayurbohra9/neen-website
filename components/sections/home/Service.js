                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 big-column">
                        ...
                        <div className="row clearfix">
                            <div className="col-lg-6 col-md-6 col-sm-12 single-column">
                                <div className="single-item" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                                    ...
                                    <div className="service-block-two">
                                        <div className="inner-box">
                                            ...
                                            <div className="link"><Link href="/service-details/custom-research-&-consulting-service"><i className="icon-1"></i></Link></div>
                                ...
                                <div className="link"><Link href="/service-details/data-driven-strategy-&-reports-service"><i className="icon-1"></i></Link></div>
                            </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-12 single-column">
                                <div className="service-block-two" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                                    <div className="inner-box">
                                        ...
                                        <div className="link"><Link href="/service-details/academic-&-writing-services-service"><i className="icon-1"></i></Link></div>
                                ...
                                <div className="link"><Link href="/service-details/marketing-insights-&-evaluation-service"><i className="icon-1"></i></Link></div>
                    ...
                    <div className="col-lg-4 col-md-12 col-sm-12 small-column">
                        <div className="service-block-two" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                            <div className="inner-box">
                                ...
                                <div className="link"><Link href="/service-details/ui-ux-&-visual-content-service"><i className="icon-1"></i></Link></div>
                            </div>
                        </div>
                        <div className="service-block-two" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                            <div className="inner-box">
                                ...
                                <div className="link"><Link href="/service-details/patent-&-ip-solutions-service"><i className="icon-1"></i></Link></div>
                            ...
                            <div className="inner-box">
                                ...
                                <div className="link"><Link href="/service-details/website-&-app-development-service"><i className="icon-1"></i></Link></div>
