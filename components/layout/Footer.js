                ...
                <div className="row clearfix">
                    <div className="col-lg-6 col-md-12 col-sm-12 footer-column">
                        <div className="footer-widget logo-widget" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="700">
                            <figure className="footer-logo mb_25"><Link href="/"><img src="/neen-black.png" alt=""/></Link></figure>
                            <figure className="footer-logo-light mb_25"><Link href="/"><img src="/neen-white.png" alt=""/></Link></figure>
